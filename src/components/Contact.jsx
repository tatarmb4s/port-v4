...
const Contact = () => {
  return (
    <div className="szunet w-full md:h-screen">
      ...
      <div name='contact' className='w-full md:h-screen bg-mainColor flex justify-center items-center p-4'>
          <form method='POST' action="https://getform.io/f/fad4cd15-130b-495d-9c14-06e8cc339d7c" className='flex flex-col max-w-[600px] w-full'>
              ...
              <h1 className='secondary-title text-gray-300'>Kapcsolat</h1>
                  <p className='text-gray-300 py-4'>Töltsd ki az ürlapot, vagy írj emailt a <a href="mailto:tatar.matyas.bence4c@hotmail.com'">tatar.matyas.bence4c@hotmail.com</a> címre</p>
              </div>
